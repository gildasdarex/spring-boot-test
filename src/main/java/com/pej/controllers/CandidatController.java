...
public class CandidatController {
	...
	@Autowired private CandidatJpaRepo candidatJpaRepo;
	@Autowired private ParametresRepository parametresRepository;
    ...
    Candidat objCandidat,
    	...
    	/*if (result.hasErrors()) {
        	System.out.println("Error on form");
            return "frmCandidat";
        }*/
        
       /* try {
        	saveImage(objCandidat.getNom() + ".jpg", image);
        } catch (IOException e) {
